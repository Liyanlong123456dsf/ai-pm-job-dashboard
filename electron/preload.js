...
contextBridge.exposeInMainWorld('api', {
  ...
  // BOSS 账号池
  bossPoolStatus: () => ipcRenderer.invoke('boss:pool-status'),
  bossManualLogin: (alias) => ipcRenderer.invoke('boss:manual-login', alias),
  bossStopManualLogin: (alias) => ipcRenderer.invoke('boss:stop-manual-login', alias),
  bossResetAccount: (alias) => ipcRenderer.invoke('boss:reset-account', alias),

  // 飞书告警
  feishuStatus: () => ipcRenderer.invoke('feishu:status'),
  feishuTest: () => ipcRenderer.invoke('feishu:test'),
  feishuTestAlert: () => ipcRenderer.invoke('feishu:test-alert'),
  feishuTestReport: () => ipcRenderer.invoke('feishu:test-report'),
  feishuResetThrottle: () => ipcRenderer.invoke('feishu:reset-throttle'),

  // 数据清洗
  cleanupStatus: () => ipcRenderer.invoke('cleanup:status'),
